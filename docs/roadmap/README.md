...
Active epic: EPIC-006 (In Progress). TASK-018, TASK-019, and TASK-020 are
Completed. TASK-021 is Blocked on missing advertised environments and
keeps its partial linux/arm64 v0.1.7 qualification record; that record
does not close TASK-020. X-025 still allows at most one active epic and
one active task. After this close there is no In Progress task.
...
from EPIC-006. TASK-019 and TASK-020 are Completed. TASK-021 already holds
a partial linux/arm64 v0.1.7 record and is Blocked until the remaining
